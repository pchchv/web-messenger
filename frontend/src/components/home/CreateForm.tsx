...
import { RoomFormValues, RoomFormElement } from '../../utils/interfaces/interfacesForm'
...
const CreateForm: React.FC = () => {
    ...
    const handleSubmit = async (event: React.FormEvent<RoomFormElement>) => {
        ...
        if (formValues.name && formValues.password) {
            ...
            await axios.post("/v1/",{ name: formValues.name, password: formValues.password }, rOptions)
            .then((response) => {
